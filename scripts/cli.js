...
const contractABI = require("../artifacts/contracts/Algorandasset.sol/Algorandasset.json").abi;

program
    .name("algorandasset-cli")
    .description("CLI tool for Algorandasset smart contract")
    .version("1.0.0");
